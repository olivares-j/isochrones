...
#--------- Sources -----------------
n_sources = 2 # Use None to select all sources in file_data
#--------------------------
...
#------------ Files -------------------------------
dir_base   = "/raid/jromero/OCs/Perseus/run_0/" #Don't forget / at the end
dir_data   = dir_base + "data/"
dir_chain  = dir_base + "chains/"
dir_plots  = dir_base + "plots/"
dir_outs   = dir_base + "outputs/"
file_data  = dir_data + "members_run_0+2MASS+PanSTARRS.csv"
#---------------------------------------------------
